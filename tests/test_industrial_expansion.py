...
class RegistryAndEmbedTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_new_names_do_not_collide_with_static_legacy_commands(self):
        ...
        names={"fiche","cv","rank","achievements","succes","objectives","objectifs","bilan","indstats","partners","orders","notifications","adminlog","economycheck","economyreport","ereport","tutorial","tuto","season","saison","titles","titres","title","events","evenements","equipe","crew"}
