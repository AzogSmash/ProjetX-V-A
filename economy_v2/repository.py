...
class IndustrialEconomyRepository(Protocol):
    ...
    def get_economy_report(self, now: int | None = None): ...
    def get_tutorial(self, user_id: int): ...
    def update_tutorial(self, user_id: int, action: str, request_id: str): ...
    def get_tutorial_hint(self, user_id: int): ...
